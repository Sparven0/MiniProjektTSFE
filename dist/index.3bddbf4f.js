...
async function displayBookIds() {
    try {
        const data = await (0, _functions.getData)();
        console.log(data);
        if (data.books && Array.isArray(data.books)) data.books.forEach(function(book) {
            ...
            function addRemoveButton() {
                if (!bookWrapper.querySelector('.removeBtn')) {
                    ...
                    removeBtn.addEventListener('click', async ()=>{
                        await (0, _functions.deleteBook)(book.ID, displayBookIds);
                        location.reload();
                    });
                }
            }
            ...
            saveBtn.addEventListener("click", async ()=>{
                console.log(book.ID);
                const readStat = readEl.checked;
                await (0, _functions.changeReadStatus)(book.ID, readStat);
                await (0, _functions.changeReviewStatus)(book.ID, reviewStat);
                if (readStat && reviewEl.value === 'disliked') addRemoveButton();
                else removeRemoveButton();
            });
        });
...
},{"./functions":"j4gwV"}],"j4gwV":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "getData", ()=>getData);
parcelHelpers.export(exports, "changeReadStatus", ()=>changeReadStatus);
...
async function changeReadStatus(ID, readStat) {
...
async function changeReviewStatus(id, reviewStat) {
...
async function deleteBook(id, callback) {
